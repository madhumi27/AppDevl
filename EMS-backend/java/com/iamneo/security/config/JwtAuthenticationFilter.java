...
//            Empall empall = empallRepository.findByContactEmail(userEmail).orElse(null);
//            if (jwtService.isTokenValid(jwtToken, empall)) {
//                UserDetails userDetails = new User(empall.getContact().getEmail(), empall.getPersonal().getPassword(),
//                        Collections.singleton(new SimpleGrantedAuthority(empall.getRole().name())));
//
